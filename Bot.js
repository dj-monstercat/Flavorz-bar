(function () {
    ...
    var loadChat = function (cb) {
        ...
        $.get("https://github.com/dj-monstercat/Flavorz-bar/blob/master/en.json", function (json) {
    ...
    var trapbot = {
        ...
        name: "Flavorz bar",
        loggedInID: null,
        scriptLink: "https://cdn.jsdelivr.net/gh/dj-monstercat/Flavorz-bar/Bot.js",
        cmdLink: "http://goo.gl/qPOuYn",
        chatLink: "https://cdn.jsdelivr.net/gh/dj-monstercat/Flavorz-bar/en.json",
        chat: null,
        loadChat: loadChat,
        ...
        room: {
            ...
            autodisableFunc: function () {
                if (trapbot.status && trapbot.settings.autodisable) {
                    API.sendChat('don't forget to bookmark the room');
                }
            },
            queueing: 0,
            queueable: true,
